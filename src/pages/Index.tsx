        ...
        <div className="relative text-center space-y-4 md:space-y-8 py-8 md:py-16 px-4 md:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-4 md:mb-8">
            {heroFeatures.map((feature, index) => (
              <Badge key={index} variant="secondary" className="px-2 md:px-4 py-1 md:py-2 text-xs md:text-sm">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-6">
            <Button asChild size="lg" className="text-sm md:text-lg px-4 md:px-8 py-3 md:py-6">
              <Link to="/auth">
                <Rocket className="w-4 h-4 md:w-5 md:h-5 mr-2" />
                Start Learning Free
              </Link>
            </Button>
            <Button variant="outline" size="lg" className="text-sm md:text-lg px-4 md:px-8 py-3 md:py-6" asChild>
              <Link to="/auth">
      ...
      <div>
        ...
        <div className="grid gap-4 md:gap-8 grid-cols-1 lg:grid-cols-3">
          {userTypes.map((userType, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/50 h-full">
        ...
        <CardContent>
          <div className="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {gettingStartedSteps.map((step, index) => (
              <div key={index} className="text-center p-3 md:p-6 rounded-xl bg-background/50 border relative">
        ...
        <CardContent className="space-y-2 md:space-y-4">
          {faqItems.map((faq, index) => (
            <div key={index} className="border rounded-lg">
              ...
              {openFaq === index && (
                <div className="p-3 md:p-4 pt-0 text-xs md:text-sm text-muted-foreground border-t">
                  {faq.answer}
                </div>
              )}
            </div>
      ...
      <Card className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-primary/20">
        <CardContent className="text-center py-6 md:py-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
            <Button size="lg" asChild className="text-sm md:text-lg px-4 md:px-8 py-3 md:py-6">
              <Link to="/auth">
